...
curl -u admin:admin "https://$HOSTNAME/solr/admin/collections?action=CREATE&name=my-collection&numShards=1&tlogReplicas=2&maxShardsPerNode=1&collection.configName=project-configs" --insecure
